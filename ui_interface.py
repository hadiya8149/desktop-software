...
################################################################################
## Form generated from reading UI file 'interfaceageihA.ui'
##
...
"background-color: rgb(0, 0, 0);")
        ...
        self.SideMenuBar_container_frame.setMaximumSize(QSize(0, 16777215))
...
"font: italic 14pt \"aakar\";")
        ...
        self.horizontalLayout_3.addWidget(self.label_3, 0, Qt.AlignLeft|Qt.AlignTop)
...
"}")
        ...
        self.page.setGeometry(QRect(0, 0, 100, 58))
        ...
        icon = QIcon()
        icon.addFile(u":/newPrefix/icons8-home.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/newPrefix/icons8-customer-100.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/newPrefix/icons8-mobile-order-128.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/newPrefix/icons8-product-64.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/newPrefix/icons8-member-50.png", QSize(), QIcon.Normal, QIcon.Off)
        self.toolBox.addItem(self.page_5, icon4, u"Employees")
        self.page_6 = QWidget()
        ...
        icon5 = QIcon()
        icon5.addFile(u":/newPrefix/icons8-depot-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.toolBox.addItem(self.page_6, icon5, u"Distributors")
        ...
        icon6 = QIcon()
        icon6.addFile(u":/newPrefix/gnome_logout.ico", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/newPrefix/icons8-menu-50.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        ...
        icon8 = QIcon()
        icon8.addFile(u":/newPrefix/icons8-search-50.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon9 = QIcon()
        icon9.addFile(u"icon_imgs/user-16.ico", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/newPrefix/icons8-notification-50.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/newPrefix/exit.ico", QSize(), QIcon.Normal, QIcon.Off)
